...
import re
import itertools
files = os.listdir("C:\\Users\Iamem\Desktop\Январь")

os.chdir("C:\\Users\Iamem\Desktop\Январь")
...
df.to_excel("C:\\Users\Iamem\Desktop\отчеты_январь.xlsx")
os.chdir("C:\\Users\Iamem\PycharmProjects\Telegram_Bot\venv\месячный отчет.py")
